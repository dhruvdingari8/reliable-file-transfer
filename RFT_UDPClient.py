...
class RFTClient:
    ...
    def _build_headers(self, data_len) -> bytes:
        # Headers
        ip_header = build_ip_header(self.client_ip, self.server_ip, 8 + 13 + data_len)
        udp_header = build_udp_header(CLIENT_PORT, SERVER_PORT, 13 + data_len)
